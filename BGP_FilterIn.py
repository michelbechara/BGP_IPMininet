...
class BGP_FilterIn(IPTopo):
    ...
    def build(self, *args, **kwargs):
        ...
        #filter
        al_filter = AccessList(name='all', entries=('cafe:deca::2/48',))
        as4r2.get_config(BGP).filter('h2filter', from_peer=as3r2, matching=(al_filter,))
        ...
        super(BGP_FilterIn, self).build(*args, **kwargs)
